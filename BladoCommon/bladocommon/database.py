...
# BLADO-VENDORED: renamed from LarcSuperviseur/NewLarcDB
class Database:
    app_name: str = 'Blado'
    intranet_db: str = 'BladoDB'
    ...
    def _pg_params(self, section: str) -> dict:
        ...
        if not os.path.isfile(cfg_path):
            _log(f"AVERTISSEMENT : config.ini introuvable (cherché: {cfg_path}). Utilisation des valeurs par défaut.")
            print(f"AVERTISSEMENT : config.ini introuvable (cherché: {cfg_path}). Utilisation des valeurs par défaut.")
